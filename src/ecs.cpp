...
//  arykow
//
//  Created by Karim DRIDI on 02/03/2015.
//
//
...
int ecs_main() {
    ...
    sf::Font font;
    if (!font.loadFromFile(DATA_PATH "LiberationSans-Regular.ttf")) {
        cerr << "error: failed to load " DATA_PATH "/LiberationSans-Regular.ttf" << endl;
        return 1;
    }
